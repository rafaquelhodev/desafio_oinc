...
config :desafio_oinc, DesafioOincWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: DesafioOincWeb.ErrorHTML, json: DesafioOincWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: DesafioOinc.PubSub,
  live_view: [signing_salt: "DzWVGeom"]
...
config :desafio_oinc, DesafioOinc.Mailer, adapter: Swoosh.Adapters.Local
